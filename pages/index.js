...
export default function Accueil({ character_name }) {
  ...
  useEffect(() => {
    ...
    for (let character of character_name) {
      if (character.toLowerCase().includes(searchTerm.toLocaleLowerCase()))
    ...
    <>
      <div className="accueil">
        <div className="banniere">
          ...
          <div>
            <h2>
              Unleash Your Strategy: The Ultimate League of Legends Stuff and
              Damage Simulator
            </h2>
            <p>
              Discover the ultimate simulator for stuff and damage of League of
              Legends characters. Optimize your gameplay strategy, test
              different stuff, and assess the impact on your favorite
              characters' damage. Start simulating now.
            </p>
          </div>
        </div>
